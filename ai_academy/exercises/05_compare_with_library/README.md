...
In this exercise, we will use the `matrix_multiply` kernel we completed in `04_complete_matrix_multiply` and compare its performance against the hipBLAS version of DGEMM. 
